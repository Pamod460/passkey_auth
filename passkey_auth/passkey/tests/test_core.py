...
class TestBase64URL(unittest.TestCase):
    ...
    def test_hex_conversion(self):
        from passkey_auth.passkey.serialization import base64url_to_hex, hex_to_base64url
...
class TestChallengeManagement(unittest.TestCase):
    def test_generate_challenge_length(self):
        from passkey_auth.passkey.challenges import generate_challenge
...
class TestSecurityValidation(unittest.TestCase):
    def test_validate_rp_id_valid(self):
        from passkey_auth.passkey.security import validate_rp_id
